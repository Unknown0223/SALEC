...
CREATE INDEX "expenses_tenant_id_expense_type_idx" ON "expenses"("tenant_id", "expense_type");
CREATE INDEX "expenses_tenant_id_agent_id_idx" ON "expenses"("tenant_id", "agent_id");
CREATE INDEX "expenses_tenant_id_warehouse_id_idx" ON "expenses"("tenant_id", "warehouse_id");
...
-- Warehouse transfers (raw SQL module warehouse-transfers.service)
...
CREATE INDEX "warehouse_transfers_tenant_id_created_at_idx" ON "warehouse_transfers"("tenant_id", "created_at" DESC);
...
CREATE INDEX "warehouse_transfer_lines_transfer_id_idx" ON "warehouse_transfer_lines"("transfer_id");
...
-- Payment allocations (Prisma model PaymentAllocation)
